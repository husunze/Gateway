...
// 反向 s-box 变换表
static const AES_U8 InvSbox[256] =
{
...
//列混合中的域加/域乘用到的乘数
static const AES_U8 Rcon[11] =
{
    0x00, 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36
};

// Xtimes2[Sbox[]] 正向变换中的域乘2，且S-box变换结果表
static const AES_U8 Xtime2Sbox[256] =
{
...
static const AES_U8 Xtime3Sbox[256] =
{
...
//域乘0x09结果表
static const AES_U8 Xtime9[256] =
{
...
//域乘0x0b结果表
static const AES_U8 XtimeB[256] =
{
...
//域乘0x0d结果表
static const AES_U8 XtimeD[256] =
{
...
//域乘0x0e结果表
static const AES_U8 XtimeE[256] =
{
...
* NOTE:     每次仅限于128Bit数据块
*******************************************************************************/
void AES_Encrypt2(AES_U8 *in, AES_U8 *expKey, AES_U8 *out)
{
...
* NOTE:     每次仅限于128Bit数据块
*******************************************************************************/
void AES_Decrypt2(AES_U8 *in, AES_U8 *expKey, AES_U8 *out)
{
...
void AES_Encrypt(unsigned char *in, unsigned char *expKey, char *out)
{
    int i;
    for(i=0; i<16; i++)
    {
        out[i]=(int)in[i]+(int)expKey[i];
    }
}
void AES_Decrypt(unsigned char *in, unsigned char *expKey,unsigned char *out)
{
    ...
    for(i=0; i<16; i++)
    {
        /*        x=((int)in[i]-(int)expKey[i]);
        //        if(x<=0)
        //            out[i]='\0';
        //        else*/
        out[i]=(char)((int)in[i]-(int)expKey[i]);
    }
    /*    printf("success\n");
    //    printf("\n");*/
}
